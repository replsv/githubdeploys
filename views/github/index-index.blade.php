<h1>
    Projects
    {{ HTML::link( handles('orchestra::resources/github/manage/'), 'Add project', array('class' => 'btn btn-small btn-primary right') ) }}
</h1>
        ...
        <tr>
            ...
            <td>
                <div style="float: right;">
                    ...
                    {{ HTML::link( handles('orchestra::resources/github/manage/' . $project->id), 'Edit', array('class' => 'btn btn-info') ) }}
                    {{ HTML::link( handles('orchestra::resources/github.releases/index/' . $project->id), 'Releases', array('class' => 'btn btn-warning') ) }}
...
<script type="text/javascript">
    ...
    $(".delete-btn").click(function(event) {
        ...
        var url = '{{ URL::to_action( 'orchestra::resources/github/delete/') }}/';
