<h1>
    ...
    Add project
    @endif
    {{ HTML::link( handles('orchestra::resources/githubdeploys'), 'Back', array('class' => 'btn btn-small btn-primary right') ) }}
</h1>
{{ Form::open( handles('orchestra::resources/githubdeploys/manage/'), 'POST', array('class' => 'awesome')) }}
    <fieldset>
