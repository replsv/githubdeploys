<div class="well">
    <h4>
        ...
        {{ HTML::link( handles('orchestra::resources/githubdeploys/manage/' . $project->id), 'Edit', array('class' => 'btn btn-danger') ) }}
    </h4>
        ...
        <tr>
            ...
            <td>
                <div style="float: right;">
                    ...
                    @else
                    {{ HTML::link( handles('orchestra::resources/githubdeploys.releases/use/' . $release->id), 'Use in production', array('class' => 'btn btn-primary') ) }}
                    @endif
                    {{ HTML::link( handles('orchestra::resources/githubdeploys.releases/view/' . $release->id), 'View', array('class' => 'btn btn-success') ) }}
                    {{ HTML::link( handles('orchestra::resources/githubdeploys.releases/pull/' . $release->id), 'Pull', array('class' => 'btn btn-info') ) }}
...
<script type="text/javascript">
    ...
    $(".delete-release-btn").click(function(event) {
        ...
        var url = '{{ str_replace('githubdeploys/releases', 'githubdeploys.releases', URL::to_action( 'resources/githubdeploys.releases@delete/') ) }}/';
